...
const renderOnlyFieldOverride = (..._args: unknown[]) => ({});
const classNameFieldOverrides = renderOnlyFieldOverride;
const childrenFieldOverrides = renderOnlyFieldOverride;
const commonFieldOverrides = renderOnlyFieldOverride;
const functionPropFieldOverrides = renderOnlyFieldOverride;
...
export const shadcnComponentDefinitions: ComponentRegistry = {
        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  {
                    id: "sheet-description-text",
                    type: "span",
                    name: "span",
                    props: {},
                    children: "Sheet description goes here.",
                  } satisfies ComponentLayer,
                ],
              },
            ],
    ...
    defaultChildren: [
      {
        ...
        type: "RadioGroupItem",
        name: "RadioGroupItem",
        props: { value: "option1", id: "option1" },
        children: [],
      },
      {
        id: "radio-item-2",
        type: "RadioGroupItem",
        name: "RadioGroupItem",
        props: { value: "option2", id: "option2" },
        children: [],
      },
    ],
    fieldOverrides: {
    ...
    defaultChildren: [
      {
        ...
        type: "AvatarImage",
        name: "AvatarImage",
        props: { src: "https://github.com/shadcn.png", alt: "Avatar" },
        children: [],
      },
      {
        id: "avatar-fallback",
        ...
        children: [
          {
            ...
            name: "span",
            props: {},
            children: "Collapsible content here",
          } satisfies ComponentLayer,
        ],
      },
    ],
  ...
  ContextMenu: {
    ...
    defaultChildren: [
      {
        id: "contextmenu-trigger",
        type: "ContextMenuTrigger",
        name: "ContextMenuTrigger",
        props: {
          className:
            "flex h-24 w-48 items-center justify-center rounded-md border border-dashed text-sm",
        },
        children: [
          {
            id: "cmt-text",
            ...
            children: [
              {
                ...
                name: "span",
                props: {},
                children: "Item description text",
              } satisfies ComponentLayer,
            ],
          },
        ],
