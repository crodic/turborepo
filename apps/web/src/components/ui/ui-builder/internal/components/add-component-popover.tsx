...
const fallback = (
  <div className='bg-muted h-full w-full animate-pulse rounded border' />
)
              ...
              <button
                className={cn(
                  ...
                  activeView === 'components'
                    ? 'bg-background border-primary border-b-2'
              ...
              >
                {categories.map((category) => (
                  ...
                  >
                    ...
                    <div className='text-muted-foreground min-h-[12px] w-full text-left text-[8px] leading-[9px] text-wrap'>
                      {category}
                    </div>
                  </TabsTrigger>
                ))}
              ...
              <TabsList className='flex h-14 w-full flex-row justify-start overflow-x-scroll rounded-none border-b'>
                {blockCategories.map((category) => (
                  ...
                  >
                    ...
                    <div className='text-muted-foreground min-h-[12px] w-full text-left text-[8px] leading-[9px]'>
    ...
    return (
      <div ref={ref} className='h-full w-full'>
        {shouldLoad ? (
          ...
          <div className='bg-muted h-full w-full rounded border' />
        )}
      </div>
    )
  }
...
const ChildOnlyPlaceholder = memo(
  ({ componentType }: { componentType: string }) => {
    ...
    return (
      <div className='bg-muted/50 flex h-full w-full items-center justify-center rounded border border-dashed'>
...
const ComponentPreview = memo(
  ({
    ...
    if (!previewLayer) {
      return <div className='bg-muted h-full w-full rounded border' />
    }
    ...
    return (
      <div
        className='bg-background pointer-events-none h-full w-full origin-top-left scale-50 transform overflow-hidden rounded border'
        style={style}
