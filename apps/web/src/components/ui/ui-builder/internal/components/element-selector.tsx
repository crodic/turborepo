      ...
      {boundingRect && (
        ...
        >
          <div
            ...
            className={cn(
              'fixed box-border cursor-default hover:border-2 hover:border-blue-300 hover:bg-blue-300/20 hover:shadow-md hover:shadow-blue-500/20',
              isBeingDragged
                ? 'border-2 border-dashed border-green-500 bg-orange-50/20 opacity-70 shadow-lg'
                : isSelected
      ...
      {isSelected && (
        <div className='z-[9999]' ref={refs.setFloating} style={floatingStyles}>
          <div className='flex items-center bg-blue-500'>
            ...
            {!isBeingDragged && (
              <>
                <span className='cursor-default px-[1px] text-xs whitespace-nowrap text-white'>
                  {layer.name
                    ?.toLowerCase()
                ...
                <div className='ml-1 h-4 w-px bg-white/20' />
