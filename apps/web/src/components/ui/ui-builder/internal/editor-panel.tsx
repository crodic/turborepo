...
const ZoomControls: React.FC<{
  ...
  return (
    <TooltipProvider>
      <div className='absolute right-4 bottom-24 z-[1000] flex rounded-full shadow-lg md:bottom-4'>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              data-testid='button-ZoomIn'
              variant='secondary'
              className='border-border size-14 rounded-l-full rounded-r-none border-r md:size-10 [&_svg]:size-7 [&_svg]:md:size-4'
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              variant='secondary'
              className='border-border size-14 rounded-none border-r md:size-10 [&_svg]:size-7 [&_svg]:md:size-4'
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className='size-14 rounded-l-none rounded-r-full md:size-10 [&_svg]:size-7 [&_svg]:md:size-4'
...
const EditorPanel: React.FC<EditorPanelProps> = ({ className }) => {
  const { selectLayer, selectedLayerId, findLayerById, selectedPageId } =
    useLayerStore()
...
const EditorPanelContent: React.FC<EditorPanelContentProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        'relative flex size-full flex-col bg-[radial-gradient(hsl(var(--border))_1px,hsl(var(--primary)/0.05)_1px)] [background-size:16px_16px] bg-fixed will-change-auto',
        className
      )}
    >
      <TransformWrapper
      ...
      <AddComponentsPopover parentLayerId={selectedPageId} enableDragToCanvas>
        <Button
          variant='secondary'
          size='icon'
          className='bg-secondary absolute bottom-4 left-4 z-[1000] flex size-14 items-center rounded-full shadow-lg md:size-10 [&_svg]:size-7 [&_svg]:md:size-4'
        >
