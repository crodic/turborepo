        ...
        >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className='flex items-center'>
                  <span>Base</span>
                  {base && (
                    <Badge className='ml-1 h-[18px] min-w-[18px] justify-center px-[3px] text-center !text-[10px]'>
          ...
          <TabsTrigger value='md' data-testid='md-tab-trigger'>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className='flex items-center'>
                  <span className='overflow-hidden text-nowrap text-ellipsis whitespace-nowrap'>
                    Tablet & Desktop
                  </span>
                  {md && (
                    <Badge className='ml-1 h-[18px] min-w-[18px] justify-center px-[3px] text-center !text-[10px]'>
