...
export function ToggleGroup({
  ...
  return (
    <div>
      ...
      <div
        className={cn(
          'bg-muted flex w-fit flex-wrap items-center gap-1 rounded-md p-1',
          className
        )}
      >
        {options.map((option) => {
                    ...
                    <div className='flex items-center'>
                      <DropdownMenuTrigger asChild>
                        <Button
                          ...
                          size='sm'
                          className={cn(
                            'flex h-8 min-w-8 items-center justify-between gap-px rounded-r-none p-1',
                        ...
                        >
                          ...
                          >
                            {option.icon ? (
                              <div className='text-muted-foreground contents'>
                                {option.icon}
                              </div>
                            ) : (
                          ...
                          <ChevronDown className='text-muted-foreground/60 ml-1 !size-3 shrink-0' />
                        </Button>
                      </DropdownMenuTrigger>
                      ...
                      {isSelected && option.dropdown && (
                        <Button
                          ...
                          size='sm'
                          className={cn(
                            'border-l-border h-8 cursor-pointer rounded-l-none rounded-r-md border-l px-1 focus:outline-none',
                            selectedClass
                          )}
  ...
  return (
    <div className='flex w-full flex-row items-center justify-start text-center'>
      {color && (
        <span
          className={cn(
            'border-border mr-1 inline-block size-[14px] rounded-full border',
            color
          )}
        />
      )}
