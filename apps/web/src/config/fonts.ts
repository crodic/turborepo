 ...
 * This array is used to control personal font preferences.
 * The `dynamic` option disables the personal override and uses the active runtime theme font.
 *
 ...
 *   }
 */
export const fonts = ['dynamic', 'inter', 'manrope', 'system'] as const
