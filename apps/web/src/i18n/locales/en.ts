export default {
  ...
  'requestMap.title': 'Request Map & Logs',
  'requestMap.description':
    'Geographical overview of system requests and detailed execution logs.',
  'requestMap.popup.status': 'Status',
  'requestMap.popup.ip': 'IP',
  'requestMap.popup.duration': 'Duration',
  'requestMap.table.method': 'Method',
  'requestMap.table.path': 'Path',
  'requestMap.table.status': 'Status',
  'requestMap.table.duration': 'Duration',
  'requestMap.table.ip': 'IP Address',
  'requestMap.table.browser': 'Browser',
  'requestMap.table.os': 'OS',
  'requestMap.table.time': 'Time',
  'navigation.general.cmsPages': 'CMS Pages',
  'navigation.general.requestMap': 'Request Map',
