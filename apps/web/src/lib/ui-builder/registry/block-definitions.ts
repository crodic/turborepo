...
const loginBlocks: BlockDefinition[] = [
          ...
          children: [
            {
              ...
              name: 'CardTitle',
              props: {},
              children: [textSpan('login-01-title-text', 'Login')],
            },
            {
              id: 'login-01-desc',
        ...
        },
        {
          ...
          children: [
            ...
            divContainer('login-01-password-group', 'space-y-2', [
              ...
              {
                id: 'login-01-password-input',
                type: 'Input',
                name: 'Input',
                props: { type: 'password', id: 'password' },
                children: [],
              },
            ]),
          ],
          ...
          children: [
            {
              ...
              children: [textSpan('login-01-btn-text', 'Sign In')],
            },
          ],
        },
      ],
    ...
    template: {
      ...
      children: [
          ...
          children: [
            {
              ...
              name: 'CardTitle',
              props: {},
              children: [textSpan('login-02-title-text', 'Welcome back')],
            },
            {
              id: 'login-02-desc',
              type: 'CardDescription',
              ...
              props: {},
              children: [
                textSpan('login-02-desc-text', 'Sign in to your account'),
              ],
            },
          ],
        },
        {
          ...
          children: [
            {
              id: 'login-02-google-btn',
              type: 'Button',
              name: 'Button',
              props: { variant: 'outline', className: 'w-full' },
              children: [
                textSpan('login-02-google-text', 'Continue with Google'),
              ],
            },
            {
              id: 'login-02-github-btn',
              type: 'Button',
              name: 'Button',
              props: { variant: 'outline', className: 'w-full' },
              children: [
                textSpan('login-02-github-text', 'Continue with GitHub'),
              ],
            },
            divContainer('login-02-divider', 'relative', [
              {
                id: 'login-02-separator',
                type: 'Separator',
                name: 'Separator',
                props: {},
                children: [],
          ...
          children: [
            {
              ...
              name: 'Button',
              props: { className: 'w-full' },
              children: [textSpan('login-02-btn-text', 'Sign In')],
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    template: divContainer(
      'login-03-root',
      'grid min-h-[400px] grid-cols-2 overflow-hidden rounded-lg border',
      [
          ...
          divContainer('login-03-form-inner', 'w-full max-w-sm space-y-6', [
            ...
            divContainer('login-03-fields', 'space-y-4', [
              ...
              ]),
              {
                ...
                name: 'Button',
                props: { className: 'w-full' },
                children: [textSpan('login-03-btn-text', 'Sign In')],
              },
            ]),
          ]),
        ]),
  ...
  },
  {
    ...
    template: divContainer(
      'login-04-root',
      'flex min-h-[350px] items-center justify-center',
      [
        divContainer('login-04-form', 'w-full max-w-sm space-y-6', [
          ...
          divContainer('login-04-fields', 'space-y-4', [
            ...
            },
            {
              ...
              name: 'Button',
              props: { className: 'w-full' },
              children: [textSpan('login-04-btn-text', 'Sign In')],
            },
          ]),
          divContainer('login-04-footer', 'text-center text-sm', [
            {
              id: 'login-04-footer-text',
              type: 'span',
              name: 'span',
              props: { className: 'text-muted-foreground' },
            ...
            {
              id: 'login-04-signup-link',
              type: 'a',
              name: 'a',
              props: { href: '#', className: 'underline' },
              children: [textSpan('login-04-signup-text', 'Sign up')],
            },
          ]),
        ]),
      ]
          ...
          children: [
            {
              ...
              children: [textSpan('login-05-title-text', 'Login')],
            },
            {
              id: 'login-05-desc',
              type: 'CardDescription',
        ...
        },
        {
          ...
          children: [
            ...
            divContainer('login-05-password-group', 'space-y-2', [
              divContainer(
                'login-05-password-header',
                'flex items-center justify-between',
                [
                  {
                    id: 'login-05-password-label',
                    type: 'Label',
                    name: 'Label',
                    props: { htmlFor: 'password' },
                    children: 'Password',
                  ...
                  {
                    id: 'login-05-forgot-link',
                    type: 'a',
                    name: 'a',
                    props: { href: '#', className: 'text-sm underline' },
                    children: [
                      textSpan('login-05-forgot-text', 'Forgot password?'),
                    ],
                  },
                ]
              ),
              {
                id: 'login-05-password-input',
                type: 'Input',
                name: 'Input',
                props: { type: 'password', id: 'password' },
                children: [],
          ...
          children: [
            {
              ...
              name: 'Button',
              props: { className: 'w-full' },
              children: [textSpan('login-05-btn-text', 'Sign In')],
            },
            divContainer('login-05-signup', 'text-center text-sm', [
              {
                id: 'login-05-signup-text',
                type: 'span',
                name: 'span',
                props: { className: 'text-muted-foreground' },
                children: "Don't have an account? ",
              ...
              {
                id: 'login-05-signup-link',
                type: 'a',
                name: 'a',
                props: { href: '#', className: 'underline' },
                children: [textSpan('login-05-signup-link-text', 'Sign up')],
              },
            ]),
          ],
        },
    ...
    children: [
      {
        ...
        children: [
            ...
            children: [
              {
                ...
                children: [
                  {
                    id: `sidebar-${num}-group-label`,
                    type: 'SidebarGroupLabel',
                    name: 'SidebarGroupLabel',
                    props: {},
                    children: [textSpan(`sidebar-${num}-gl-text`, 'Menu')],
                  },
                  {
                    id: `sidebar-${num}-menu`,
                    type: 'SidebarMenu',
                    ...
                    children: [
                      {
                        ...
                        children: [
                          {
                            id: `sidebar-${num}-btn-1`,
                            type: 'SidebarMenuButton',
                            name: 'SidebarMenuButton',
                            props: {},
                            children: [
                              textSpan(
                                `sidebar-${num}-btn-1-text`,
                                'Dashboard'
                              ),
                            ],
                          },
                      ...
                      },
                      {
                        ...
                        children: [
                          {
                            id: `sidebar-${num}-btn-2`,
                            type: 'SidebarMenuButton',
                            name: 'SidebarMenuButton',
                            props: {},
                            children: [
                              textSpan(`sidebar-${num}-btn-2-text`, 'Settings'),
                            ],
                          },
                        ],
                      },
          ...
          },
          {
            ...
            name: 'SidebarFooter',
            props: {},
            children: [textSpan(`sidebar-${num}-footer-text`, 'Footer')],
          },
        ],
      },
      {
            ...
            children: [
              {
                ...
                children: [
                  {
                    id: 'dashboard-01-stat-1-title',
                    type: 'CardTitle',
                    name: 'CardTitle',
                    props: { className: 'text-sm font-medium' },
                    children: [textSpan('d01-s1-title', 'Total Revenue')],
                  },
                ],
              },
              {
            ...
            children: [
              {
                ...
                children: [
                  {
                    id: 'dashboard-01-stat-2-title',
                    type: 'CardTitle',
                    name: 'CardTitle',
                    props: { className: 'text-sm font-medium' },
                    children: [textSpan('d01-s2-title', 'Subscriptions')],
                  },
                ],
              },
              {
            ...
            children: [
              {
                ...
                children: [
                  {
                    id: 'dashboard-01-stat-3-title',
                    type: 'CardTitle',
                    name: 'CardTitle',
                    props: { className: 'text-sm font-medium' },
                    children: [textSpan('d01-s3-title', 'Sales')],
                  },
                ],
              },
              {
            ...
            children: [
              {
                ...
                children: [
                  {
                    id: 'dashboard-01-stat-4-title',
                    type: 'CardTitle',
                    name: 'CardTitle',
                    props: { className: 'text-sm font-medium' },
                    children: [textSpan('d01-s4-title', 'Active Now')],
                  },
                ],
              },
              {
        ...
        children: [
          {
            ...
            name: 'CardTitle',
            props: {},
            children: [textSpan(`${name}-title-text`, description)],
          },
          {
            id: `${name}-desc`,
            type: 'CardDescription',
            name: 'CardDescription',
            props: {},
            children: [textSpan(`${name}-desc-text`, 'Chart visualization')],
          },
        ],
      },
      {
        ...
        props: {
          className:
            'h-[300px] flex flex-col items-center justify-center gap-4',
        },
        children: [
          divContainer(
            `${name}-placeholder`,
            'text-muted-foreground text-center space-y-2',
            [
              {
                id: `${name}-icon`,
                type: 'div',
              ...
              textSpan(`${name}-placeholder-text`, description),
              {
                ...
                type: 'p',
                name: 'p',
                props: { className: 'text-xs max-w-[250px]' },
                children:
                  'Charts require Recharts data integration. Use ChartContainer with AreaChart, BarChart, LineChart, etc.',
              },
            ]
          ),
        ],
      ...
      children: [
        {
          ...
          children: [
            {
              id: 'chart-area-default-title',
              type: 'CardTitle',
              name: 'CardTitle',
              props: {},
              children: [
                textSpan('chart-area-default-title-text', 'Area Chart'),
              ],
            },
            {
              id: 'chart-area-default-desc',
              type: 'CardDescription',
              name: 'CardDescription',
              props: {},
              children: [
                textSpan(
                  'chart-area-default-desc-text',
                  'Showing desktop and mobile visitors'
                ),
              ],
            },
          ],
      ...
      children: [
        {
          ...
          children: [
            {
              id: 'chart-bar-default-title',
              type: 'CardTitle',
              name: 'CardTitle',
              props: {},
              children: [textSpan('chart-bar-default-title-text', 'Bar Chart')],
            },
            {
              id: 'chart-bar-default-desc',
              type: 'CardDescription',
              name: 'CardDescription',
              props: {},
              children: [
                textSpan(
                  'chart-bar-default-desc-text',
                  'Showing desktop and mobile visitors'
                ),
              ],
            },
      ...
      children: [
        {
          ...
          children: [
            {
              id: 'chart-line-default-title',
              type: 'CardTitle',
              name: 'CardTitle',
              props: {},
              children: [
                textSpan('chart-line-default-title-text', 'Line Chart'),
              ],
            },
            {
              id: 'chart-line-default-desc',
              type: 'CardDescription',
              name: 'CardDescription',
              props: {},
              children: [
                textSpan(
                  'chart-line-default-desc-text',
                  'Showing desktop and mobile visitors'
                ),
              ],
            },
      ...
      children: [
        {
          ...
          children: [
            {
              id: 'chart-pie-donut-title',
              type: 'CardTitle',
              name: 'CardTitle',
              props: {},
              children: [textSpan('chart-pie-donut-title-text', 'Pie Chart')],
            },
            {
              id: 'chart-pie-donut-desc',
              type: 'CardDescription',
              name: 'CardDescription',
              props: {},
              children: [
                textSpan(
                  'chart-pie-donut-desc-text',
                  'Browser visitors breakdown'
                ),
              ],
            },
          ],
...
const chartRadarBlocks: BlockDefinition[] = [
  ...
  createChartPlaceholder(
    ...
    'chart',
    'Radar chart with circle grid'
  ),
  createChartPlaceholder(
    'chart-radar-grid-circle-fill',
    'chart',
    'Radar chart with filled circle grid'
  ),
  createChartPlaceholder(
    'chart-radar-grid-circle-no-lines',
    'chart',
    'Radar chart circle grid no lines'
  ),
  createChartPlaceholder(
...
const chartTooltipBlocks: BlockDefinition[] = [
  createChartPlaceholder(
    ...
    'chart',
    'Advanced tooltip chart'
  ),
  createChartPlaceholder(
    'chart-tooltip-default',
    'chart',
    'Default tooltip chart'
  ),
  createChartPlaceholder(
 ...
 */
export const blockDefinitions: BlockRegistry = allBlocks.reduce(
  (acc, block) => {
